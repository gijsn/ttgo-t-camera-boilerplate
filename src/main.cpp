...
void setup() {
  ...
  WiFi.begin("Oakwood2", "8583659229");
  ...
  Serial.println("Oakwood2");
  Serial.print("IP address: ");
  Serial.println(WiFi.localIP());
  configTime(0, 3600, "0.nl.pool.ntp.org", "1.nl.pool.ntp.org");
  struct tm timeinfo;
...
void enterSleep() {
  tft.end();
  time_started = micros();
  esp_sleep_enable_timer_wakeup(5 * 60 * 1000000-time_started);
...
//---------------------
static UINT tjd_file_input(JDEC *jd,    // Decompression object
